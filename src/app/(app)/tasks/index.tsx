...
export default function TasksWorkbenchScreen() {
  ...
  const allDisplayTasks: (Task & { assigneeName?: string })[] = useMemo(() => {
    ...
    return flattened;
  }, [viewMode, myTasksQuery.data, teamDashboardQuery.data]);
  ...
  return (
    <ScreenWrapper refreshing={isRefetching} onRefresh={handleRefresh}>
      <View style={styles.contentWrapper}>
        {/* 1. ROLE-AWARE VIEW SEGMENT (OWNER ONLY) */}
        {isOwner ? (
          ...
          <EmptyState
            ...
            description={
              viewMode === 'my'
                ...
                : 'No tasks currently scheduled across the workshop floor.'
            }
          />
