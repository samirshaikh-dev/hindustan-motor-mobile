...
export default function DashboardScreen() {
  ...
  const waitingCount = attentionTasks.length;
      ...
      <View style={styles.contentWrapper}>
        ...
        <View style={styles.topHeader}>
          <View style={styles.headerTextGroup}>
            ...
            <Text style={styles.subtitle}>Shop-Floor Overview</Text>
          </View>
          ...
          <>
            ...
            <View style={styles.summaryCard}>
              ...
              <Pressable
                ...
                <Text style={styles.summaryStatLabel}>Waiting</Text>
                <Text
                  style={[
                    styles.summaryStatVal,
                    waitingCount > 0 && styles.warningText,
                  ]}>
                  {waitingCount}
                </Text>
              </Pressable>
                ...
                {team.slice(0, 5).map((member, index) => {
                  ...
                  return (
                    <Pressable
                      ...
                      onPress={() => router.push(`/(app)/employees/${member.id}`)}>
